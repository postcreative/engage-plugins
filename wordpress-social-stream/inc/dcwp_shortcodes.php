...
//	print_r($atts);
	...
	$out .= 'if(!jQuery().dcSocialStream) { $.getScript("'.dc_jqsocialstream::get_plugin_directory().'/js/jquery.social.stream.1.5.2.min.js", function(){$("#social-stream-'.$id.'").dcSocialStream(config);}); } else {';
...
//	print_r($atts);
	...
	$out .='<script type="text/javascript">jQuery(document).ready(function($){';
	$out .= 'var config = '.$config.';';
	$out .= 'if(!jQuery().dcSocialStream) { $.getScript("'.dc_jqsocialstream::get_plugin_directory().'/js/jquery.social.stream.wall.1.3.js", function(){}); $.getScript("'.dc_jqsocialstream::get_plugin_directory().'/js/jquery.social.stream.1.5.2.min.js", function(){$("#social-stream-'.$id.'").dcSocialStream(config);}); } else {';
